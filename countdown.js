...
function countdown (deadline, elem, finalMessage){
    ...
    const timerUpdate = setInterval (()=>{
        ...
        el.children[0].children[0].innerHTML = t.remainDays;
        el.children[1].children[0].innerHTML = t.remainHours;
        el.children[2].children[0].innerHTML = t.remainMinutes;
        el.children[3].children[0].innerHTML = t.remainSeconds;
